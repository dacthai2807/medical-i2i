...
os.environ["CUDA_VISIBLE_DEVICES"] = "3" #format_devices(device)
import argparse
import torch as th
...
if __name__ == "__main__":
    dataset = 'ct2pet' #cat2dog/wild2dog/male2female/multi_afhq(mutli-domain)
    #defalut args
    ...
    if dataset == 'multi_afhq':
        ...
        args.num_class = 2
        args.iterations = 5000
        args.pretrained_model = 'pretrained_model/ctnpet_classifier.pt'
        args.image_size = 128
    main(args)
