...
from datasets import get_dataset,rescale,inverse_rescale,get_CT_dataset,unscale_image
...
class EGSDE(object):
    ...
    def egsde(self,):
        ...
        #     test_flist.append('{}.npy'.format(NUM_TRAINING + i))

        dataset = get_CT_dataset(ct_dir, test_flist)
